...
function payex_init_gateway_class() {
	...
	class WC_PAYEX_GATEWAY extends WC_Payment_Gateway {
		...
		public function __construct() {
			...
			$this->icon               = 'https://payexpublic.blob.core.windows.net/storage/payex_woocommerce.jpeg'; // URL of the icon that will be displayed on checkout page near your gateway name.
